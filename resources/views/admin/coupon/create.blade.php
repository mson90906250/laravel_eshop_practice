...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['url' => route('admin.coupon.store'), 'method' => 'POST']) !!}
                ...
                <div class="row mb-3 ml-5">
                    ...
                    <div class="col-7 p-3">
                        ...
                        {!! Form::bsSelect('優惠券類型', 'value_type', request()->input('value_type') ?? '', Coupon::getTypeLabelsForShow(), '', 'vertical') !!}
                    ...
                    <div class="col-7 p-3">
                        ...
                        {!! Form::bsSelect('狀態', 'status', request()->input('status') ?? '', Coupon::getStatusLabels(), '', 'vertical') !!}
